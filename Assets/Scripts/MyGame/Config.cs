namespace MyGame
{
    public static class Config
    {
        ...
        {
            public const float GAME_SPEED = 25f;
        ...
        // GameModel
        public const float GAME_MODEL_UPGRADE_COST = 5;
        public const float GAME_MODEL_UPGRADE_EXP = 3;

        // Kitchen
        public const int KITCHEN_FOOD_COUNT_FOR_LEVEL = 1000;
        public const float KITCHEN_FOOD_COST_FOR_UNIT = 0.1f;

        public const float KITCHEN_ENOUGH_FOOD_MODIFIER = 1.2f;
        public const float KITCHEN_NOT_ENOUGH__FOODMODIFIER = 0.8f;

        public const ulong KITCHEN_UPGRADE_COST = 5;
        public const ulong KITCHEN_UPGRADE_EXP = 3;

        // Office
        public const int OFFICE_UNITS_MAX_COUNT = 7;
        public const int OFFICE_UNITS_START_COUNT = 1;
        public const int OFFICE_ORDERS_MAX_COUNT = 7;
        public const int OFFICE_ORDERS_START_COUNT = 2;

        public const ulong OFFICE_UPGRADE_COST = 5;
        public const ulong OFFICE_UPGRADE_EXP = 3;
        ...
        public const float OFFICE_PART_UPGRADE_COST = 5;
        public const float OFFICE_PART_UPGRADE_EXP = 3;
        ...
        public const float WORKER_SKILL_COST = 5;
        public const float WORKER_SKILL_COST_EXP = 3;

        public const float WORKER_UPGRADE_COST = 5;
        public const float WORKER_UPGRADE_EXP = 3;
        ...
        public const float WORKPLACE_PART_UPGRADE_COST = 5;
        public const float WORKPLACE_PART_UPGRADE_EXP = 3;
    }
}
